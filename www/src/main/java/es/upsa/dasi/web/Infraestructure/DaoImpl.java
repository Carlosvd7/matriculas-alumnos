...
import es.upsa.dasi.web.Infraestructure.util.Mappers;
import es.upsa.dasi.web.Infraestructure.util.UrlGateway;
...
public class DaoImpl implements Dao {
    ...
    public List<Alumno> findAllAlumnos() throws AppException {
        try(Client client = ClientBuilder.newClient()
            ...
            Response response = client.target(UrlGateway.URL_GATEWAY)
                    .path("/alumnos")
    ...
    public Alumno updateAlumno(Alumno alumno) throws AppException {
        try(Client client = ClientBuilder.newClient()){
            Response response = client.target(UrlGateway.URL_GATEWAY)
                    ...
                    .request(MediaType.APPLICATION_JSON)
                    .put(Entity.json(mappers.toAlumnoDto(alumno)));
    ...
    public Expediente addExpediente(Expediente expediente) throws AppException {
        try(Client client = ClientBuilder.newClient()){
            Response response = client.target(UrlGateway.URL_GATEWAY)
                    .path("/expedientes")
                    .request(MediaType.APPLICATION_JSON)
                    .post(Entity.json(mappers.toExpedienteDto(expediente)));
    ...
    public Expediente updateExpediente(Expediente expediente) throws AppException {
        try(Client client = ClientBuilder.newClient()){
            Response response = client.target(UrlGateway.URL_GATEWAY)
                    ...
                    .request(MediaType.APPLICATION_JSON)
                    .put(Entity.json(mappers.toExpedienteDto(expediente)));
