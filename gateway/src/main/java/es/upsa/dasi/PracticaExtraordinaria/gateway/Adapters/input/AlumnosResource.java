...
public class AlumnosResource {
    ...
    UriInfo uriInfo;
    @Inject
    FindAllAlumnoUseCase findAllAlumnosUseCase;
    @Inject
    ...
    public Response findAlumnoByDni(@PathParam("dni") String dni) throws AppException {
        Alumno alumno = findAlumnoByDniUseCase.findAlumnoByDni(dni);
        if(alumno.dni() == null){
    ...
    public Response addAlumno(Alumno alumno) throws AppException {
        ...
        Alumno alumnoByDni = findAlumnoByDniUseCase.findAlumnoByDni(alumno.dni());
        ...
        Alumno newAlumno = addAlumnoUseCase.addAlumno(alumno);
    ...
    public Response updateAlumno(@PathParam("dni")String dni, AlumnoDto alumnoDto) throws AppException {
        ...
        Alumno alumno2 = updateAlumnoUseCase.updateAlumno(alumno1);
    ...
    public Response deleteAlumno(@PathParam("dni")String dni) throws AppException {
        ...
        String borrado = deleteAlumnoUseCase.deleteAlumno(dni);
        if(borrado!=null){
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(ExceptionDto.builder()
                            .withMessage(borrado)
